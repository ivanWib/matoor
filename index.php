                                ...
                                <div style="background-color:#161B22" class="card mb-4 shadow p-3 mb-3">
                                    ...
                                    <div class="d-flex flex-row justify-content-between align-items-center mt-2">
                                        <div style="color:#C8CDD1" class="px-2 pt-2 d-flex gap-2">
                                            <a style="text-decoration:none; color:#C8CDD1" href="like.php?id=<?= $row["id_post"] ?>&header=index">
                                        ...
                                        <div>
                                            <?php if ($login == "1") { ?>
                                                <div>
                                                    <a style="text-decoration:none; color:#C8CDD1" href="delete.php?id=<?= $row["id_post"] ?>&header=index&table=posts&data=null">
