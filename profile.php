        ...
        <div id="body" style="height:570px; width:1200px; margin-top:80px; background-color:#21262D; color:#F9F8F8" class="card overflow-auto">
            <div id="content" class="d-flex flex-row w-100">
                <div id="PROFILE" class="w-25 d-flex justify-content-center position-fixed">
                    <div style="height:380px; background-color:#161B22; color:#C8CDD1" class="w-75 mt-5 card d-flex flex-column align-items-center shadow p-3 mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-title text-center"><?= $data["email"]; ?></p>
                        </div>
                        ...
                        <div class="d-flex gap-5">
                            <?php if ($login == "1") { ?>
                                <div>
                                    ...
                                    <a style="text-decoration:none; color:#C8CDD1" href="delete.php?id=<?= $id ?>&header=profile&table=users&data=null">
