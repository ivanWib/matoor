    ...
    <div id="container" class="d-flex flex-column align-items-center">
        <div id="navbar" class="navbar fixed-top d-flex justify-content-between">
            <div class="container d-flex justify-content-end gap-4">
                ...
                <a class="d-flex" style="text-decoration:none; color:#F0F6FC" href="category.php?category=jaksel script">
        ...
        <div id="body" style="height:570px; width:900px; margin-top:80px; background-color:#21262D; color:#F9F8F8" class="card overflow-auto">
                                    ...
                                    <div class="d-flex flex-row justify-content-between align-items-center mt-2">
                                        ...
                                        <div style="color:#C8CDD1" class="px-2 pt-2 d-flex gap-2">
                                            <a style="text-decoration:none; color:#C8CDD1" href="comment.php?id=<?= $row["id_post"] ?>">
                                                <iconify-icon icon="heroicons:chat-bubble-oval-left-ellipsis-solid" width="20" height="20"></iconify-icon>
                                            </a>
                                        ...
                                        <div>
                                            <?php if ($login == "1") { ?>
                                                <div>
                                                    <a style="text-decoration:none; color:#C8CDD1" href="delete.php?id=<?= $row["id_post"] ?>&header=category&table=posts&data=<?= $category ?>">
